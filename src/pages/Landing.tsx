/**
 * Landing Page
 * Marketing landing page for Lynx platform
 * Note: This file is lengthy due to marketing content sections
 */
  ...
  return (
    <div className="min-h-screen bg-[#09090B] text-[#F4F4F5] selection:bg-zinc-700">
      ...
      <section className="max-w-7xl mx-auto px-6 py-40" id="reputation">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 reveal-anim">
          {/* Card 1: Duality */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
            <div className="relative">
              <div className="sticky top-40 space-y-20">
                {[
                  { num: '01', title: 'Onboard with Intent.', desc: 'Verify your identity via phone to secure the community. No bots. No spam. Just humans.' },
                  { num: '02', title: 'Log Experiences.', desc: 'What have you actually done? Share your journey with hard evidence. Build your proof-graph.' },
                  { num: '03', title: 'Help & Scale.', desc: 'Accept requests, mentor peers, and earn Karma. Your reputation grows with every session.' },
                ].map(step => (
                  <div key={step.num} className="reveal-anim">
                    <div className="text-[10px] font-black text-zinc-600 uppercase tracking-widest mb-4">Step {step.num}</div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start gap-16 mb-24">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-16">
              {[
                { title: 'Platform', links: ['Discover', 'Reputation', 'Karma'] },
                { title: 'Vision', links: ['Identity', 'Security', 'Whitepaper'] },
                { title: 'Connect', links: ['Twitter', 'LinkedIn', 'Email'] },
              ].map(col => (
                <div key={col.title} className="space-y-4">
                  <h4 className="text-[10px] font-black text-white uppercase tracking-widest">{col.title}</h4>
                  <div className="flex flex-col gap-2">
                    {col.links.map(link => (
                      <a key={link} href="#" className="text-zinc-600 hover:text-white transition-colors text-xs font-medium">{link}</a>
                    ))}
                  </div>
                </div>
              ))}
